...
bot = telebot.TeleBot('7302214503:AAGfNkUIRK0AmkDLwvvciHgrkdi_U7gecso')

# Admin user IDs
admin_id = ["6141252240","5923628266"]
...
🚀 Buy From :- @Mahadevomnama
🚀 Official Channel :- https://t.me/GAMELOADERRISHI
'''
...
def welcome_start(message):
    ...
    response = f'''👋🏻Welcome to The Bot, LOVE U 💖
                    🤖Feel Free to Explore. 
                    ✅Join :- https://t.me/GAMELOADERRISHI'''
    bot.reply_to(message, response)
